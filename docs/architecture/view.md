...
MachiVerse の利用者体験を要件定義・設計するときは、利用者ロール「ダイバー」が、あたかもシミュレーション世界へフルダイブしているかのように感じられる体験を最大化することを上位原則とします。

ダイバーを単に世界状態を閲覧してコマンドを送る外部クライアントとして扱うのではなく、シミュレーション世界の住民として世界の中に存在し、世界から影響を受け、自身の行動が世界へ影響を返す存在として体験できる方向を優先して検討します。

要件候補を比較する場合は、少なくとも次の観点からフルダイブ感への寄与を検討します。

- 世界の外から操作している感覚ではなく、世界の中に存在している感覚を高められるか
- ダイバーの行動と世界から返る結果の因果関係を連続的に感じられるか
- シミュレーション住民と同じ世界のルール・制約・相互作用の中に参加できるか
- 周囲の世界や住民がダイバーの存在・行動に応じて変化し、その結果がさらにダイバーへ返ってくるか
- UIやシステム都合が、世界への没入を不必要に分断しないか
- 世界シミュレーションの深さを、ダイバー自身の体験として感じ取れるか

ただし、「フルダイブ」は体験目標を示す設計上の表現です。この原則だけを根拠に、VR、AR、HMD、触覚、音声、視線、身体トラッキング、BCI等の特定技術を採用すると確定してはなりません。具体的な提示技術、対応デバイス、操作方式、身体表現、視点、感覚表現は別途要件として定義します。

また、フルダイブ体験の最大化は、ダイバーだけに都合のよい結果を世界側で演出することを意味しません。第一原則である「狂気的なまでに世界をシミュレーションする」ことと両立させ、ダイバーも世界の一員としてシミュレーションされた因果関係の中へ参加する方向を基本とします。
...
ダイバー参加の設計では、フルダイブしているかのような体験の最大化を常に評価軸とします。
